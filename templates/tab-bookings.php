...
?>
<div class="wte-dbg-master-detail" data-post-type="booking">
	<div class="wte-dbg-list-panel">
		<div class="wte-dbg-list-header">
			<strong><?php esc_html_e( 'BOOKINGS', 'wptravelengine-devzone' ); ?></strong>
			<span class="wte-dbg-list-count"></span>
		</div>
		<div class="wte-dbg-search-wrap">
			<input type="search"
				class="wte-dbg-search"
				placeholder="<?php esc_attr_e( 'Search bookings…', 'wptravelengine-devzone' ); ?>">
		</div>
	...
	<div class="wte-dbg-inspector-panel">
		<div class="wte-dbg-inspector-placeholder">
			<p><?php esc_html_e( '← Select a booking to inspect', 'wptravelengine-devzone' ); ?></p>
		</div>
	</div>
</div>
